...
bool waitFor( std::function<bool()> pred, std::chrono::milliseconds timeout = 100ms )
{
...
TEST( ESP32Test, communication )
{
  ...
  ASSERT_TRUE( waitFor( [&comm]() { return comm.available() > 0; }, 3s ) );
